    ...
    public static AutofitHelper create(TextView view, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    R.styleable.AutoFitColorTextView,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(R.styleable.AutoFitColorTextView_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(R.styleable.AutoFitColorTextView_minTextSize,
                    minTextSize);
            precision = ta.getFloat(R.styleable.AutoFitColorTextView_precision, precision);
            ta.recycle();
